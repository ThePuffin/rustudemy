...
// fn main () {
//     let name_to_get ="Sandy";

//     let mut contacts=HashMap::new();
//     contacts.insert("Bob","+33789456123");
//     contacts.insert("Sandy", "+33123456789");
   
//     let get_the_number = contacts.get(name_to_get);
//     if get_the_number != None{
//     println!("{} : {:?}", name_to_get, get_the_number);
//     }
//     else {
//         println!("User unknow");
//     }
